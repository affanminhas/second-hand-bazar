...
import 'refund_policy_page_model.dart';
export 'refund_policy_page_model.dart';

class RefundPolicyPageWidget extends StatefulWidget {
  const RefundPolicyPageWidget({super.key});

  @override
  State<RefundPolicyPageWidget> createState() => _RefundPolicyPageWidgetState();
}

class _RefundPolicyPageWidgetState extends State<RefundPolicyPageWidget> {
  late RefundPolicyPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RefundPolicyPageModel());
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: AutoSizeText(
                      'Last updated on 3rd September 2024\nSecond Hand Bazaar believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:',
                  ...
                  RichText(
                    ...
                    text: TextSpan(
                      children: [
                        ...
                        TextSpan(
                          text:
                              '\n\n◦Second Hand Bazaar does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.\n',
                          style: FlutterFlowTheme.of(context)
                              .bodyMedium
                              .override(
                                fontFamily: FlutterFlowTheme.of(context)
