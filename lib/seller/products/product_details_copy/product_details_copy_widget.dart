...
class ProductDetailsCopyWidget extends StatefulWidget {
  ...
  @override
  State<ProductDetailsCopyWidget> createState() =>
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ProductsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final productDetailsCopyProductsRecord = snapshot.data!;
                          ...
                          context.pushNamed(
                            ...
                            queryParameters: {
                              'productRef': serializeParam(
                                productDetailsCopyProductsRecord.reference,
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                                      ...
                                      child: FlutterFlowExpandedImageView(
                                        image: Image.network(
                                          valueOrDefault<String>(
                                            productDetailsCopyProductsRecord
                                                .images.first,
                            ...
                            if (productDetailsCopyProductsRecord.images.length >
                                1)
                              Align(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            valueOrDefault<String>(
                              productDetailsCopyProductsRecord.name,
                              'name',
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            valueOrDefault<String>(
                              productDetailsCopyProductsRecord.category,
                              'Empty',
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                              ...
                              children: [
                                ...
                                TextSpan(
                                  text: valueOrDefault<String>(
                                    formatNumber(
                                      productDetailsCopyProductsRecord.price,
                    ...
                    if (productDetailsCopyProductsRecord.sizes.isNotEmpty)
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Builder(
                              builder: (context) {
                                final productSizes =
                                    productDetailsCopyProductsRecord.sizes
                                        .toList();
                    ...
                    if (productDetailsCopyProductsRecord.colour.isNotEmpty)
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            24.0, 24.0, 12.0, 0.0),
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final color = productDetailsCopyProductsRecord
                                      .colour
                                      .toList();
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            valueOrDefault<String>(
                              productDetailsCopyProductsRecord.description,
                              'No description',
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            valueOrDefault<String>(
                              productDetailsCopyProductsRecord.quantity
                                  .toString(),
                              '1',
                            ),
                            style: FlutterFlowTheme.of(context)
                    ...
                    if (productDetailsCopyProductsRecord.paymentMethods.isNotEmpty)
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            24.0, 24.0, 24.0, 0.0),
                        child: Column(
