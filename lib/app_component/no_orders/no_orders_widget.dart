...
import 'no_orders_model.dart';
export 'no_orders_model.dart';
...
class _NoOrdersWidgetState extends State<NoOrdersWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NoOrdersModel());
      ...
      children: [
        ...
        Align(
          ...
          child: Padding(
            ...
            child: Text(
              'It seems that you don\'t have any recent orders.',
