  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<BuyerRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<BuyerRecord> orderPageBuyerRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final orderPageBuyerRecord = orderPageBuyerRecordList.isNotEmpty
            ? orderPageBuyerRecordList.first
            : null;
                    ...
                    Padding(
                      ...
                      child: Text(
                        valueOrDefault<String>(
                          orderPageBuyerRecord?.reference.id,
                          'error',
                        ),
                        textAlign: TextAlign.start,
                        style:
                        ...
                        builder: (context, snapshot) {
                          ...
                          return Column(
                            ...
                            children: List.generate(
                                columnOrderRecordList.length, (columnIndex) {
                              ...
                              return Padding(
                                ...
                                child: StreamBuilder<ProductsRecord>(
                                  stream: ProductsRecord.getDocument(
                                      columnOrderRecord.productOrdered.first),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
                                      return Center(
                                    ...
                                    final listContainerProductsRecord =
                                        snapshot.data!;
