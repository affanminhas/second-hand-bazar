...
import 'recommend_item_page_model.dart';
export 'recommend_item_page_model.dart';

class RecommendItemPageWidget extends StatefulWidget {
  const RecommendItemPageWidget({super.key});

  @override
  State<RecommendItemPageWidget> createState() =>
      _RecommendItemPageWidgetState();
}

class _RecommendItemPageWidgetState extends State<RecommendItemPageWidget> {
  late RecommendItemPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecommendItemPageModel());
