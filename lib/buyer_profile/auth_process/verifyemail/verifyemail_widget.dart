              ...
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(61.0, 0.0, 61.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        ...
                        children: [
                          Flexible(
                            child: Text(
                              'Click on Verify Button and Please check your E-mail',
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          if (currentUserEmailVerified) {
                            context.goNamed('BuyerVerificationsuccessful');
                          } else {
                            await showDialog(
                              context: context,
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  ...
                                  content: const Text(
                                      'Please check your email and verify your mail'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'Verification E-mail has been resend succesfully! Please Verify Now',
                                    style: TextStyle(
