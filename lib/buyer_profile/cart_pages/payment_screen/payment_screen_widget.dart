...
class PaymentScreenWidget extends StatefulWidget {
  const PaymentScreenWidget({
    ...
    String? deliveryType,
  })  : deliveryInstruction = deliveryInstruction ?? 'No Instruction',
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CartRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CartRecord> paymentScreenCartRecordList = snapshot.data!;
        ...
        return Scaffold(
          ...
          body: Align(
            ...
            child: StreamBuilder<AddressRecord>(
              stream: AddressRecord.getDocument(widget.addressRef!),
              builder: (context, snapshot) {
                // Customize what your widget looks like when it's loading.
                if (!snapshot.hasData) {
                  return Center(
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child: Image
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            menuItemProductsRecord.images.first,
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        valueOrDefault<String>(
                                                                          formatNumber(
                                                                            functions.multiplyPrice(cartItemItem.finalPrice,
                                                                                1.0),
                                                                            formatType:
                                                                                FormatType.custom,
                                                                            currency:
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      Padding(
                                        ...
                                        child: StreamBuilder<List<BuyerRecord>>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<BuyerRecord>
                                                buttonBuyerRecordList =
                                                snapshot.data!;
                                            // Return an empty Container when the item does not exist.
                                            if (snapshot.data!.isEmpty) {
                                              return Container();
                                            }
                                            final buttonBuyerRecord =
                                                buttonBuyerRecordList.isNotEmpty
                                                    ? buttonBuyerRecordList
                                                        .first
                                                    : null;
                                              ...
                                              onPressed: () async {
                                                await OrderRecord.collection
                                                  ...
                                                  ...createOrderRecordData(
                                                    buyerId: buttonBuyerRecord
                                                        ?.reference,
                                                    deliveryInstructions: widget
                                                        .deliveryInstruction,
                                                    shippingAddress:
                                                        columnAddressRecord
                                                            .address,
                                                ...
                                                await buttonBuyerRecord!
                                                    .reference
                                                    .update(
                                                        createBuyerRecordData(
                                                  numberOfItems: 1,
                                                ));
                                    ...
                                    if (_model.radioButtonValue !=
                                        'Pay on Delivery')
                                      StreamBuilder<List<BuyerRecord>>(
                                        stream: queryBuyerRecord(
                                          queryBuilder: (buyerRecord) =>
                                              buyerRecord.where(
                                            'email',
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<BuyerRecord>
                                              placeOrderWidgetBuyerRecordList =
                                              snapshot.data!;
                                          // Return an empty Container when the item does not exist.
                                          if (snapshot.data!.isEmpty) {
                                            return Container();
                                          }
                                          final placeOrderWidgetBuyerRecord =
                                              placeOrderWidgetBuyerRecordList
                                                      .isNotEmpty
                                                  ? placeOrderWidgetBuyerRecordList
                                                      .first
                                          ...
                                          return SizedBox(
                                            ...
                                            height: 55.0,
                                            child:
                                                custom_widgets.PlaceOrderWidget(
                                              width: double.infinity,
                                              height: 55.0,
                                              amount:
                                                  functions.calculateCartTotal(
                                                      paymentScreenCartRecordList
                                                          .toList()),
                                              name: placeOrderWidgetBuyerRecord!
                                                  .name,
                                              contact:
                                                  placeOrderWidgetBuyerRecord
                                                      .phoneNumber
                                                      .toString(),
                                              email:
                                                  placeOrderWidgetBuyerRecord
                                                      .email,
                                              description:
                                                  'Second Hand Bazaar Checkout',
                                              deliveryInstruction:
                                                  widget.deliveryInstruction,
                                              shippingAddress:
                                                  columnAddressRecord.address,
                                              cartItems: valueOrDefault<int>(
                                                paymentScreenCartRecordList
                                                    .length,
                                                1,
                                              ),
