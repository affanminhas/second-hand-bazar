  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<BuyerRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<BuyerRecord> paymentMethodBuyerRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final paymentMethodBuyerRecord = paymentMethodBuyerRecordList.isNotEmpty
            ? paymentMethodBuyerRecordList.first
            : null;
