...
import 'seller_register_main_model.dart';
export 'seller_register_main_model.dart';

class SellerRegisterMainWidget extends StatefulWidget {
  const SellerRegisterMainWidget({super.key});

  @override
  State<SellerRegisterMainWidget> createState() =>
      _SellerRegisterMainWidgetState();
}

class _SellerRegisterMainWidgetState extends State<SellerRegisterMainWidget> {
  late SellerRegisterMainModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SellerRegisterMainModel());
    ...
    _model.paswordTextController ??= TextEditingController();
    _model.paswordFocusNode ??= FocusNode();
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      autofocus: true,
                                      obscureText: !_model.paswordVisibility,
                                      decoration: InputDecoration(
                                        labelText: 'Password',
                                      ...
                                      textAlign: TextAlign.start,
                                      validator: _model
                                          .paswordTextControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                  Align(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  context.pushNamedAuth(
                                      'SellerVerifyemail', context.mounted);
                                },
                                text: 'Register',
