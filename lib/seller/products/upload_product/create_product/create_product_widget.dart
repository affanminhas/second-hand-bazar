...
class _CreateProductWidgetState extends State<CreateProductWidget> {
  ...
  void initState() {
    ...
    _model.hasDiscountPriceValue = false;
    _model.discountTextfiledTextController ??= TextEditingController();
    _model.discountTextfiledFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ProductsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductsRecord> createProductProductsRecordList = snapshot.data!;
        final createProductProductsRecord =
            createProductProductsRecordList.isNotEmpty
                ? createProductProductsRecordList.first
                : null;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            floatingActionButton: FloatingActionButton.extended(
              ...
              elevation: 8.0,
              label: StreamBuilder<List<SellerRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<SellerRecord> containerSellerRecordList = snapshot.data!;
                  // Return an empty Container when the item does not exist.
                  if (snapshot.data!.isEmpty) {
                    return Container();
                  }
                  final containerSellerRecord =
                      containerSellerRecordList.isNotEmpty
                          ? containerSellerRecordList.first
                          : null;
                  ...
                  return InkWell(
                    ...
                    onTap: () async {
                      await ProductsRecord.collection.doc().set({
                        ...
                        ...mapToFirestore(
                          {
                            'sizes': [_model.sizesValue],
                            'colour': [_model.colorTextController.text],
                            'images': [_model.uploadedFileUrl1],
                          },
                        ),
                      });
                      unawaited(
                        () async {
                          await createProductProductsRecord!.reference.update({
                            ...mapToFirestore(
                              {
                                                    ...
                                                    child: ClipRRect(
                                                      ...
                                                      child: Image.network(
                                                        valueOrDefault<String>(
                                                          _model
                                                              .uploadedFileUrl1,
                                                          'https://www.creativefabrica.com/wp-content/uploads/2021/04/20/Image-upload-icon-Graphics-11109264-1-312x208.jpg',
                                                        ),
                                                        width: 300.0,
                                                        height: 200.0,
                                                        fit: BoxFit.cover,
                                    ...
                                    SizedBox(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          filled: true,
                                          fillColor: const Color(0x065272F2),
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        width: 340.0,
                                        decoration: BoxDecoration(
                                          color: const Color(0x065272F2),
                                          borderRadius:
                                              BorderRadius.circular(25.0),
                                          border: Border.all(
                                            color: const Color(0x5A575B6C),
                                          ),
                                        ),
                                        child: Row(
                                          mainAxisSize: MainAxisSize.max,
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .discountTextfiledTextController,
                                                      focusNode: _model
                                                          .discountTextfiledFocusNode,
                                                      autofocus: true,
                                                      obscureText: false,
                                                      decoration:
                                                          InputDecoration(
