...
class _EditProductWidgetState extends State<EditProductWidget> {
  ...
  void initState() {
    ...
    _model.discounFocusNode ??= FocusNode();
              ...
              actions: [
                Align(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      await editProductProductsRecord.reference.update({
                        ...
                        ...mapToFirestore(
                          {
                            'delivery': FieldValue.arrayRemove([
                              (editProductProductsRecord.delivery.isNotEmpty)
                                  .toString()
                            ]),
                            ...
                            'sizes': FieldValue.arrayRemove([
                              (editProductProductsRecord.sizes.isNotEmpty)
                                  .toString()
                            ]),
                          },
                        ),
                      ...
                      await editProductProductsRecord.reference.update({
                        ...
                        ...mapToFirestore(
                          {
                            'delivery':
                                FieldValue.arrayUnion([_model.deliveryValue]),
                            'payment_methods':
                                FieldValue.arrayUnion([_model.paymentValue]),
                            'sizes': FieldValue.arrayUnion(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            await ProductsRecord.collection.doc().set({
                              ...
                              ...mapToFirestore(
                                {
                                  'sizes': [_model.choiceChipsValue],
                                  'images': [
                                    editProductProductsRecord.images.first
                                  ],
                                },
                              ),
                            });
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Visibility(
                        visible: editProductProductsRecord.images.isNotEmpty,
                        child: Padding(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    final productImage =
                                        editProductProductsRecord.images
                                            .toList();
                                    ...
                                    return SingleChildScrollView(
                                      ...
                                      child: Row(
                                        ...
                                        children:
                                            List.generate(productImage.length,
                                                (productImageIndex) {
                                          final productImageItem =
                                              productImage[productImageIndex];
                                          return Visibility(
                                            visible: productImageItem != '',
                                            child: ClipRRect(
                                              borderRadius:
                                ...
                                child: StreamBuilder<List<CategoriesRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return FlutterFlowRadioButton(
                                      options: categoryCategoriesRecordList
                                          .map((e) => e.category)
                                          .toList()
                                          .toList(),
                                          ...
                                          child: TextFormField(
                                            controller:
                                                _model.priceTextController ??=
                                                    TextEditingController(
                                              text: formatNumber(
                                                editProductProductsRecord.price,
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: FlutterFlowIconButton(
                                      borderColor: const Color(0x5888888E),
                                      borderRadius: 20.0,
                                      borderWidth: 1.0,
                                      buttonSize: 40.0,
                                      icon: Icon(
                                  ...
                                  Expanded(
                                    child: FlutterFlowChoiceChips(
                                      ...
                                      selectedChipStyle: ChipStyle(
                                        backgroundColor: const Color(0xFF072541),
                                        textStyle: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily:
                                      ...
                                      child: Padding(
                                        ...
                                        child: SizedBox(
                                          ...
                                          child: TextFormField(
                                            ...
                                            focusNode: _model.discounFocusNode,
                                            autofocus: true,
                                            obscureText: false,
                                            decoration: InputDecoration(
                                              labelStyle:
                                            ...
                                            validator: _model
                                                .discounTextControllerValidator
                                                .asValidator(context),
                                          ),
                                        ),
                                      ),
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      14.0, 0.0, 0.0, 0.0),
                                  child: Text(
                                    editProductProductsRecord.colour
                                        .contains(editProductProductsRecord
                                            .reference.id)
                                        .toString(),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.descriptionTextController ??=
                                          TextEditingController(
                                    text: editProductProductsRecord.description,
                                  ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: FlutterFlowRadioButton(
                              options: ['Pick-up', 'Delivery'].toList(),
                              onChanged: (val) => safeSetState(() {}),
