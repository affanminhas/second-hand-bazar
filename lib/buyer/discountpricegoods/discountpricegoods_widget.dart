...
import 'discountpricegoods_model.dart';
export 'discountpricegoods_model.dart';

class DiscountpricegoodsWidget extends StatefulWidget {
  const DiscountpricegoodsWidget({super.key});

  @override
  State<DiscountpricegoodsWidget> createState() =>
      _DiscountpricegoodsWidgetState();
}

class _DiscountpricegoodsWidgetState extends State<DiscountpricegoodsWidget> {
  late DiscountpricegoodsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DiscountpricegoodsModel());
