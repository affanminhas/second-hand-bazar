import '/app_component/no_chat/no_chat_widget.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<SellerRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SellerRecord> chatUsersSellerRecordList = snapshot.data!;
        final chatUsersSellerRecord = chatUsersSellerRecordList.isNotEmpty
            ? chatUsersSellerRecordList.first
            : null;
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl: chatUsersSellerRecord!.image,
                          fit: BoxFit.cover,
                      ...
                      child: StreamBuilder<List<MessagesRecord>>(
                        stream: queryMessagesRecord(
                          queryBuilder: (messagesRecord) =>
                            ...
                            'user',
                            isEqualTo: chatUsersSellerRecord.reference.id,
                          ),
                        ),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          ...
                          if (listViewMessagesRecordList.isEmpty) {
                            return NoChatWidget(
                              sellerRef: chatUsersSellerRecord.reference,
                            );
                          }
